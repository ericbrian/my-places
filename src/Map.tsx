...
function MapComponent() {
  ...
  return (
    <Map
      ...
      minZoom={1}
      interactiveLayerIds={[
        "home-points", "work-points", "pleasure-points", "home-symbols", "work-symbols", "pleasure-symbols",
      ...
      {popupInfo && (
        ...
        >
          <div style={{ padding: "8px" }}>
            <h3 style={{ margin: "0 0 8px 0", color: "#333", display: "flex", alignItems: "center", gap: "8px" }}>
            ...
            <p style={{
              ...
              padding: "4px 8px",
              backgroundColor:
                popupInfo.placeType === "Home" ? "#E8F5E8" :
                  popupInfo.placeType === "Work" ? "#E3F2FD" :
                    popupInfo.placeType === "Pleasure" ? "#FCE4EC" :
                      "#FFF3E0",
              color:
                popupInfo.placeType === "Home" ? "#4CAF50" :
                  popupInfo.placeType === "Work" ? "#2196F3" :
                    popupInfo.placeType === "Pleasure" ? "#E91E63" :
                      "#FF9800",
              borderRadius: "4px",
              fontSize: "12px",
              fontWeight: "bold"
      ...
      <div style={{
        ...
        <div style={{ display: "flex", flexDirection: "column", gap: "8px" }}>
          <div style={{
            ...
            <div style={{ display: "flex", alignItems: "center", justifyContent: "center", width: "20px", height: "20px", borderRadius: "50%", backgroundColor: "#4CAF50", border: "2px solid white", fontSize: "12px" }}>🏠</div>
          ...
          <div style={{
            ...
            <div style={{ display: "flex", alignItems: "center", justifyContent: "center", width: "20px", height: "20px", borderRadius: "50%", backgroundColor: "#2196F3", border: "2px solid white", fontSize: "12px" }}>💼</div>
          ...
          <div style={{
            ...
            <div style={{ display: "flex", alignItems: "center", justifyContent: "center", width: "20px", height: "20px", borderRadius: "50%", backgroundColor: "#E91E63", border: "2px solid white", fontSize: "12px" }}>🎉</div>
